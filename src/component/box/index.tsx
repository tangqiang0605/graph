...
const cardData = new Map([
  ['支付金额', {
    ...
    myscore: [0, 0, 0, 0, 0, 0, 989, 1226, 1389, 1589, 1688, 1865],
    avgscore: [0, 0, 0, 0, 0, 0, 426, 465, 496, 539, 668, 569],
    superscore: [0, 0, 0, 0, 0, 0, 806, 903, 899, 1189, 1268, 1286]
  }], ['平均停留时长', {
    myscore: [0, 0, 0, 0, 0, 0, 64.39, 68.35, 67.59, 60.65, 65.35, 78.71],
    avgscore: [0, 0, 0, 0, 0, 0, 37.32, 35.89, 32.59, 33.96, 39.38, 35.36],
    superscore: [0, 0, 0, 0, 0, 0, 58.39, 60.36, 59.85, 50.39, 60.38, 65.35]
  }], ['支付买家数', {
    myscore: [0, 0, 0, 0, 0, 0, 816, 1002, 1095, 1255, 1339, 1482],
    avgscore: [0, 0, 0, 0, 0, 0, 256, 298, 336, 412, 408, 436],
    superscore: [0, 0, 0, 0, 0, 0, 569, 750, 789, 963, 985, 1029]
  }], ['支付子订单数', {
    myscore: [0, 0, 0, 0, 0, 0, 925, 1193, 1296, 1496, 1639, 2063],
    avgscore: [0, 0, 0, 0, 0, 0, 298, 332, 369, 421, 485, 965],
    superscore: [0, 0, 0, 0, 0, 0, 716, 779, 846, 1065, 1148, 1496]
  }], ['支付件数', {
    myscore: [0, 0, 0, 0, 0, 0, 998, 1268, 1378, 1568, 1756, 2156],
    avgscore: [0, 0, 0, 0, 0, 0, 349, 390, 405, 509, 593, 1078],
    superscore: [0, 0, 0, 0, 0, 0, 926, 882, 989, 1156, 1244, 1569]
  }], ['浏览量', {
    myscore: [0, 0, 0, 0, 0, 0, 365679, 395672, 449488, 499891, 559299, 621793],
    avgscore: [0, 0, 0, 0, 0, 0, 109826, 129655, 136458, 157563, 168546, 186985],
    superscore: [0, 0, 0, 0, 0, 0, 254589, 289512, 318906, 356146, 384596, 423645]
    // }]
  }], ['成功退款金额', {
    myscore: [0, 0, 0, 0, 0, 0, 404258.47, 330215.89, 530307.87, 530215.89, 530261.81, 720315.89],
    avgscore: [0, 0, 0, 0, 0, 0, 214898.49, 182678.54, 275612.36, 261258.23, 264525.48, 362568.36],
    superscore: [0, 0, 0, 0, 0, 0, 499871.64, 431256.89, 648920.21, 612478.98, 598486.79, 895152.77]
  }], ['净支付金额', {
    myscore: [0, 0, 0, 0, 0, 0, 2568838.26, 2985263.36, 3285324.65, 3685263.36, 3985226.55, 4395263.36],
    avgscore: [0, 0, 0, 0, 0, 0, 768578.95, 894855.62, 987890.35, 1085489.56, 1264795.14, 1326429.12],
    superscore: [0, 0, 0, 0, 0, 0, 1798229.36, 2065178.36, 2293678.23, 2528947.35, 3085642.36, 3151249.36]
  }]
])
